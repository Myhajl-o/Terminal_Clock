...
class Hour_hand
{
  ...
  char min_circ_sym[17];
  char clear_min_circ_sym[17];
  bool clearing;
  bool drawing;
  ...
  void calculation_size_mini_circle(const Coordinates&size);
...
public:
  Hour_hand(const short wi,const Color_object*hour_c,const char* const*sym,const bool show_min_circ);
